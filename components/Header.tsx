    ...
    <header className="w-full bg-primary text-white p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="text-center flex-grow ml-8">
          <h1 className="text-lg font-semibold">Connecting Gators for Seamless Trading</h1>
        </div>
            ...
            <>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="text-white bg-transparent border-none hover:bg-gray-700">
                    More ▼
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="bg-white text-black w-40 mt-2">
                  ...
                  <DropdownMenuItem onClick={handleLogout} className="block px-4 py-2 hover:bg-gray-100 cursor-pointer">
                    Logout
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
